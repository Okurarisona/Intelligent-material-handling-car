...
extern u16 BACK_DATA	; 	
extern u16 RIGHT_DATA	;
extern u16 FRONT_DATA  ;
extern u16 LEFT_DATA   ;
extern u8 RGB_num[3];
extern int move_x,move_y,Track_Flag,Key_ON,RGB_flag;	//标志位
extern u8 target_data[3],target_RGB[3];
#include "gray.h"
#include "delay.h" 
#include "usart.h"
#include "motor.h"
