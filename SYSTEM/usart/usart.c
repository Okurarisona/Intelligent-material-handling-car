...
//			}else //还没收到0X0D
//			{	
				if(res==0x0d)USART_RX_STA|=0x8000;
				else
				{
...
void USART3_IRQHandler(void)
{
	...
	{	 
		...
		{
			if(res==0x0A)USART3_RX_STA|=0x8000;
			else
			{
...
{  	 
	...
	GPIO_Set(GPIOB,PIN10|PIN11,GPIO_MODE_AF,GPIO_OTYPE_PP,GPIO_SPEED_50M,GPIO_PUPD_PU);//PB9,PB10,复用功能,上拉输出
